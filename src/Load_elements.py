...
class load_elements():
    ...
    def load_images(self):
        ...
        self.image=pygame.image.load(os.path.join(self.image_path,self.config.config_visuals["image_background"][self.config_visuals["value_background"]])).convert()
        self.image=pygame.transform.scale(self.image,(self.WIDTH,self.HEIGHT))
        self.planet=pygame.image.load(os.path.join(self.image_path,self.config.config_visuals["planets"][self.config_visuals["value_planet"]])).convert_alpha()
        self.planet=pygame.transform.scale(self.planet,(40,40))
        self.spacecraft=pygame.image.load(os.path.join(self.image_path,self.config.config_visuals["spacecrafts"][self.config_visuals["value_spacecraft1"]])).convert_alpha()
        ...
        self.spacecraft2=pygame.image.load(os.path.join(self.image_path,self.config.config_visuals["spacecrafts"][self.config_visuals["value_spacecraft2"]])).convert_alpha()
