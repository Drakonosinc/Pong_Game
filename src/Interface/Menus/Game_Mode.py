...
class GameMode(BaseMenu):
    ...
    def _setup_training_ai_buttons(self):
        ...
        self.config_buttons['box_type_model'] = factory.create_ComboBox({"text": "Model","position": (self.WIDTH/2+120, self.HEIGHT/2+139),"type_dropdown": "left"})
        ...
        self.f = factory.create_TextButton({"text": "twest","position": (0,0)})
        self.config_buttons['box_type_model'].charge_buttons([self.b,self.f])
