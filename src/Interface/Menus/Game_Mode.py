...
class GameMode(BaseMenu):
    ...
    def _setup_training_qlearning_buttons(self):
        ...
        self.training_qlearning_elements["epsilon_decay_increase"] = factory.create_TextButton({"text": ">","position": (self.WIDTH-100, self.HEIGHT/2+220),"command1": lambda: self.increase_decrease_variable(self.config.config_AI["q_learning"], 'epsilon_decay', False, 0.01),"command2": self._update_training_qlearning_texts})
        self.training_qlearning_elements["epsilon_decay_decrease"] = factory.create_TextButton({"text": "<","position": (self.WIDTH-178, self.HEIGHT/2+220),"command1": lambda: self.increase_decrease_variable(self.config.config_AI["q_learning"], 'epsilon_decay', True, 0.01),"command2": self._update_training_qlearning_texts})
