...
class GameMode(BaseMenu):
    ...
    def _setup_training_ai_buttons(self):
        ...
        self.config_buttons['box_type_model'].charge_elements({"Model 1":lambda:print("hola1"), "Model 2":lambda:print("hola2"), "Model 3":lambda:print("hola3"),"Model 4":lambda:print("hola1"), "Model 5":lambda:print("hola2")})
