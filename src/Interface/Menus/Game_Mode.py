...
class GameMode(BaseMenu):
    ...
    def _setup_training_genetic_buttons(self):
        ...
        self.config_genetic_buttons['decrease_generation'] = factory.create_TextButton({"text": "<","position": (self.WIDTH-178, self.HEIGHT/2-55),"command1": lambda: self.increase_decrease_variable(self.config.config_AI["genetic"], 'generation_value', True, -1),"command2": self._update_training_genetic_texts})
        ...
        self.config_genetic_buttons['decrease_population'] = factory.create_TextButton({"text": "<","position": (self.WIDTH-178, self.HEIGHT/2),"command1": lambda: self.increase_decrease_variable(self.config.config_AI["genetic"], 'population_value', True, -1),"command2": self._update_training_genetic_texts})
    ...
    def _setup_training_qlearning_buttons(self):
        ...
        self.config_qlearning_buttons["learning_rate_increase"] = factory.create_TextButton({"text": ">","position": (self.WIDTH-100, self.HEIGHT/2),"command1": lambda: self.increase_decrease_variable(self.config.config_AI["q_learning"], 'learning_rate', False, 0.01),"command2": self._update_training_qlearning_texts})
        self.config_qlearning_buttons["learning_rate_decrease"] = factory.create_TextButton({"text": "<","position": (self.WIDTH-178, self.HEIGHT/2),"command1": lambda: self.increase_decrease_variable(self.config.config_AI["q_learning"], 'learning_rate', True, 0.01),"command2": self._update_training_qlearning_texts})
        ...
        self.config_qlearning_buttons["gamma_decrease"] = factory.create_TextButton({"text": "<","position": (self.WIDTH-178, self.HEIGHT/2+55),"command1": lambda: self.increase_decrease_variable(self.config.config_AI["q_learning"], 'gamma', True, 0.01),"command2": self._update_training_qlearning_texts})
        ...
        self.config_qlearning_buttons["epsilon_start_decrease"] = factory.create_TextButton({"text": "<","position": (self.WIDTH-178, self.HEIGHT/2+110),"command1": lambda: self.increase_decrease_variable(self.config.config_AI["q_learning"], 'epsilon_start', True, 0.01),"command2": self._update_training_qlearning_texts})
        ...
        self.config_qlearning_buttons["epsilon_end_decrease"] = factory.create_TextButton({"text": "<","position": (self.WIDTH-178, self.HEIGHT/2+165),"command1": lambda: self.increase_decrease_variable(self.config.config_AI["q_learning"], 'epsilon_end', True, 0.01),"command2": self._update_training_qlearning_texts})
        self.config_qlearning_buttons["epsilon_decay_increase"] = factory.create_TextButton({"text": ">","position": (self.WIDTH-100, self.HEIGHT/2+220),"command1": lambda: self.increase_decrease_variable(self.config.config_AI["q_learning"], 'epsilon_decay', False, 0.01),"command2": self._update_training_qlearning_texts})
