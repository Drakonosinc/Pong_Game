...
class MainMenu(BaseMenu):
    ...
    def setup_buttons(self):
        ...
        self.buttons['play'] = factory.create_TextButton({"text": "Press To Start","position": (self.WIDTH//2-200,self.HEIGHT//2-80),"command1":lambda:self.change_mains({"main":GameState.MODE_SELECT})})
        ...
        self.buttons['options'] = factory.create_TextButton({"text": "Options","position": (self.WIDTH-110,self.HEIGHT-40),"command1":lambda:self.change_mains({"main":GameState.OPTIONS})})
