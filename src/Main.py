            ...
            case {"Training AI": True}:
                ...
                if game.config.config_AI["type_training"]["Genetic"]:
                    ...
                    if game.config.config_AI["model_save"]:
                        if type_model == "Pytorch": save_genetic_model(game.model, torch.optim.Adam(game.model.parameters(), lr=0.001), game.model_path)
                        else: save_genetic_model(game.model, optimizer=None, path=game.model_path)
