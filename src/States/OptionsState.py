...
class OptionsState(State):
    ...
    def update(self, dt):
        ...
        if ui_main == GameState.VISUALS: self.game.state_manager.change_state(GameState.VISUALS)
        elif ui_main == GameState.KEYS: self.game.state_manager.change_state(GameState.KEYS)
