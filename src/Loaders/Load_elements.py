...
class load_elements():
    ...
    def load_images(self):
        ...
        self.spacecraft=pygame.image.load(os.path.join(self.image_path,self.config.config_visuals["spacecrafts"][self.config.config_visuals["value_spacecraft1"]])).convert_alpha()
        ...
        self.spacecraft2=pygame.image.load(os.path.join(self.image_path,self.config.config_visuals["spacecrafts"][self.config.config_visuals["value_spacecraft2"]])).convert_alpha()
