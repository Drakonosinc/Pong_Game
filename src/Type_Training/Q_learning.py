...
def _build_qlearning_model(type_model, state_size, action_size, hidden_sizes=None):
    if type_model != "Pytorch":
        raise NotImplementedError("Q-learning solo soporta Pytorch en este proyecto.")
    return SimpleNN_Pytorch(state_size, action_size, hidden_sizes=hidden_sizes)
class ReplayMemory:
...
class DQNAgent:
    def __init__(self, type_model, state_size: int, action_size: int, lr: float = 1e-3, gamma: float = 0.99, 
        ...
        self.policy_net = _build_qlearning_model(type_model, state_size, action_size, hidden_sizes=self._hidden_sizes)
        self.target_net = _build_qlearning_model(type_model, state_size, action_size, hidden_sizes=self._hidden_sizes)
