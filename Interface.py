...
class interface(load_elements):
    ...
    def buttons_visual(self):
        ...
        self.decrease_height_button=Button({"screen": self.screen,"font": self.font2_5,"text": "<","color": self.WHITE,"position": (self.WIDTH/2+20,self.HEIGHT/2-200),"color2": self.GOLDEN,"sound_hover": self.sound_buttonletters,"sound_touch": self.sound_touchletters,"command1":lambda: self.config_visuals.update({"HEIGHT": (self.config_visuals["HEIGHT"] - 10)}),"command2":self.config_screen})
        self.increase_height_button=Button({"screen": self.screen,"font": self.font2_5,"text": ">","color": self.WHITE,"position": (self.WIDTH/2+200,self.HEIGHT/2-200),"color2": self.GOLDEN,"sound_hover": self.sound_buttonletters,"sound_touch": self.sound_touchletters,"command1":lambda: self.config_visuals.update({"HEIGHT": (self.config_visuals["HEIGHT"] + 10)}),"command2":self.config_screen})
        self.decrease_planet_button=Button({"screen": self.screen,"font": self.font2_5,"text": "<","color": self.WHITE,"position": (self.WIDTH/2-40,self.HEIGHT/2-22),"color2": self.GOLDEN,"sound_hover": self.sound_buttonletters,"sound_touch": self.sound_touchletters,"command1":lambda: self.config_visuals.update({"value_planet": (self.config_visuals["value_planet"] - 1) % len(self.config_visuals["planets"])}),"command2":self.config_screen})
        self.increase_planet_button=Button({"screen": self.screen,"font": self.font2_5,"text": ">","color": self.WHITE,"position": (self.WIDTH/2+20,self.HEIGHT/2-22),"color2": self.GOLDEN,"sound_hover": self.sound_buttonletters,"sound_touch": self.sound_touchletters,"command1":lambda: self.config_visuals.update({"value_planet": (self.config_visuals["value_planet"] + 1) % len(self.config_visuals["planets"])}),"command2":self.config_screen})
        self.decrease_back_button=Button({"screen": self.screen,"font": self.font2_5,"text": "<","color": self.WHITE,"position": (self.WIDTH/2-80,self.HEIGHT/2+160),"color2": self.GOLDEN,"sound_hover": self.sound_buttonletters,"sound_touch": self.sound_touchletters,"command1":lambda: self.config_visuals.update({"value_background": (self.config_visuals["value_background"] - 1) % len(self.config_visuals["image_background"])}),"command2":self.config_screen})
