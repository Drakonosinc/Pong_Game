...
class interface(load_elements):
    ...
    def buttons_visual(self):
        self.back_visual_button = self.button_factory_f5.create_PolygonButton({"screen": self.screen,"position": ((50, 350), (50, 380), (25, 365)),"position2":((50, 340), (50, 390), (10, 365)),"color2": self.GOLDEN,"type_button": 1,"sound_hover": self.sound_buttonletters,"sound_touch": self.sound_touchletters,"command1":lambda:self.change_mains({"main":4})})
        self.decrease_width_button=self.button_factory_f2_5.create_TextButton({"screen": self.screen,"font": self.font2_5,"text": "<","position": (self.WIDTH/2-200,self.HEIGHT/2-200),"color2": self.GOLDEN,"sound_hover": self.sound_buttonletters,"sound_touch": self.sound_touchletters,"command1":lambda:self.change_items("WIDTH",number=-10)})
        self.increase_width_button=self.button_factory_f2_5.create_TextButton({"screen": self.screen,"font": self.font2_5,"text": ">","position": (self.WIDTH/2-40,self.HEIGHT/2-200),"color2": self.GOLDEN,"sound_hover": self.sound_buttonletters,"sound_touch": self.sound_touchletters,"command1":lambda:self.change_items("WIDTH",number=10)})
        self.decrease_height_button=self.button_factory_f2_5.create_TextButton({"screen": self.screen,"font": self.font2_5,"text": "<","position": (self.WIDTH/2+20,self.HEIGHT/2-200),"color2": self.GOLDEN,"sound_hover": self.sound_buttonletters,"sound_touch": self.sound_touchletters,"command1":lambda:self.change_items("HEIGHT",number=-10)})
        self.increase_height_button=self.button_factory_f2_5.create_TextButton({"screen": self.screen,"font": self.font2_5,"text": ">","position": (self.WIDTH/2+200,self.HEIGHT/2-200),"color2": self.GOLDEN,"sound_hover": self.sound_buttonletters,"sound_touch": self.sound_touchletters,"command1":lambda:self.change_items("HEIGHT",number=10)})
        self.decrease_planet_button=self.button_factory_f2_5.create_TextButton({"screen": self.screen,"font": self.font2_5,"text": "<","position": (self.WIDTH/2-40,self.HEIGHT/2-22),"color2": self.GOLDEN,"sound_hover": self.sound_buttonletters,"sound_touch": self.sound_touchletters,"command1":lambda:self.change_items("value_planet","planets",-1)})
        self.increase_planet_button=self.button_factory_f2_5.create_TextButton({"screen": self.screen,"font": self.font2_5,"text": ">","position": (self.WIDTH/2+20,self.HEIGHT/2-22),"color2": self.GOLDEN,"sound_hover": self.sound_buttonletters,"sound_touch": self.sound_touchletters,"command1":lambda:self.change_items("value_planet","planets",1)})
        self.decrease_back_button=self.button_factory_f2_5.create_TextButton({"screen": self.screen,"font": self.font2_5,"text": "<","position": (self.WIDTH/2-80,self.HEIGHT/2+160),"color2": self.GOLDEN,"sound_hover": self.sound_buttonletters,"sound_touch": self.sound_touchletters,"command1":lambda:self.change_items("value_background","image_background",-1)})
        self.increase_back_button=self.button_factory_f2_5.create_TextButton({"screen": self.screen,"font": self.font2_5,"text": ">","position": (self.WIDTH/2+65,self.HEIGHT/2+160),"color2": self.GOLDEN,"sound_hover": self.sound_buttonletters,"sound_touch": self.sound_touchletters,"command1":lambda:self.change_items("value_background","image_background",1)})
