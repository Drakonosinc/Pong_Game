...
class interface(load_elements):
    ...
    def buttons_visual(self):
        ...
        self.decrease_player1_button=Button({"screen": self.screen,"font": ,"text": "Λ","position": (self.WIDTH/2-330,self.HEIGHT/2-120),"color2": self.GOLDEN,"sound_hover": self.sound_buttonletters,"sound_touch": self.sound_touchletters,"command1":lambda:self.change_items("value_spacecraft1","spacecrafts",-1)})
        self.increase_player1_button=Button({"screen": self.screen,"font": ,"text": "v","position": (self.WIDTH/2-330,self.HEIGHT/2+50),"color2": self.GOLDEN,"sound_hover": self.sound_buttonletters,"sound_touch": self.sound_touchletters,"command1":lambda:self.change_items("value_spacecraft1","spacecrafts",1)})
