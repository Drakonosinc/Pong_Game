...
class interface(load_elements):
    ...
    def buttons_menu_options(self):
        ...
        self.keys_button=Button({"screen": self.screen,"font": self.font2_5,"text": "Keys","color": self.WHITE,"position": (self.WIDTH/2-80,self.HEIGHT/2-80),"color2": self.GOLDEN,"sound_hover": self.sound_buttonletters,"sound_touch": self.sound_touchletters,"command1":lambda:setattr(self,'main',6)})
        self.language_button=Button({"screen": self.screen,"font": self.font2_5,"text": "Language","color": self.WHITE,"position": (self.WIDTH/2-80,self.HEIGHT/2-45),"color2": self.GOLDEN,"sound_hover": self.sound_buttonletters,"sound_touch": self.sound_touchletters,})
    ...
    def buttons_visual(self):
        ...
        self.decrease_width_button=Button({"screen": self.screen,"font": self.font2_5,"text": "<","position": (self.WIDTH/2-200,self.HEIGHT/2-200),"color2": self.GOLDEN,"sound_hover": self.sound_buttonletters,"sound_touch": self.sound_touchletters,"command1":lambda: self.config_visuals.update({"WIDTH": (self.config_visuals["WIDTH"] - 10)}),"command2":self.config_screen})
        self.increase_width_button=Button({"screen": self.screen,"font": self.font2_5,"text": ">","position": (self.WIDTH/2-40,self.HEIGHT/2-200),"color2": self.GOLDEN,"sound_hover": self.sound_buttonletters,"sound_touch": self.sound_touchletters,"command1":lambda: self.config_visuals.update({"WIDTH": (self.config_visuals["WIDTH"] + 10)}),"command2":self.config_screen})
        self.decrease_height_button=Button({"screen": self.screen,"font": self.font2_5,"text": "<","position": (self.WIDTH/2+20,self.HEIGHT/2-200),"color2": self.GOLDEN,"sound_hover": self.sound_buttonletters,"sound_touch": self.sound_touchletters,"command1":lambda: self.config_visuals.update({"HEIGHT": (self.config_visuals["HEIGHT"] - 10)}),"command2":self.config_screen})
        self.increase_height_button=Button({"screen": self.screen,"font": self.font2_5,"text": ">","position": (self.WIDTH/2+200,self.HEIGHT/2-200),"color2": self.GOLDEN,"sound_hover": self.sound_buttonletters,"sound_touch": self.sound_touchletters,"command1":lambda: self.config_visuals.update({"HEIGHT": (self.config_visuals["HEIGHT"] + 10)}),"command2":self.config_screen})
        self.decrease_planet_button=Button({"screen": self.screen,"font": self.font2_5,"text": "<","position": (self.WIDTH/2-40,self.HEIGHT/2-22),"color2": self.GOLDEN,"sound_hover": self.sound_buttonletters,"sound_touch": self.sound_touchletters,"command1":lambda: self.config_visuals.update({"value_planet": (self.config_visuals["value_planet"] - 1) % len(self.config_visuals["planets"])}),"command2":self.config_screen})
        self.increase_planet_button=Button({"screen": self.screen,"font": self.font2_5,"text": ">","position": (self.WIDTH/2+20,self.HEIGHT/2-22),"color2": self.GOLDEN,"sound_hover": self.sound_buttonletters,"sound_touch": self.sound_touchletters,"command1":lambda: self.config_visuals.update({"value_planet": (self.config_visuals["value_planet"] + 1) % len(self.config_visuals["planets"])}),"command2":self.config_screen})
        self.decrease_back_button=Button({"screen": self.screen,"font": self.font2_5,"text": "<","position": (self.WIDTH/2-80,self.HEIGHT/2+160),"color2": self.GOLDEN,"sound_hover": self.sound_buttonletters,"sound_touch": self.sound_touchletters,"command1":lambda: self.config_visuals.update({"value_background": (self.config_visuals["value_background"] - 1) % len(self.config_visuals["image_background"])}),"command2":self.config_screen})
        self.increase_back_button=Button({"screen": self.screen,"font": self.font2_5,"text": ">","position": (self.WIDTH/2+65,self.HEIGHT/2+160),"color2": self.GOLDEN,"sound_hover": self.sound_buttonletters,"sound_touch": self.sound_touchletters,"command1":lambda: self.config_visuals.update({"value_background": (self.config_visuals["value_background"] + 1) % len(self.config_visuals["image_background"])}),"command2":self.config_screen})
        ...
        self.decrease_player2_button=Button({"screen": self.screen,"font": font,"text": "Λ","position": (self.WIDTH/2+310,self.HEIGHT/2-120),"color2": self.GOLDEN,"sound_hover": self.sound_buttonletters,"sound_touch": self.sound_touchletters,"command1":lambda: self.config_visuals.update({"value_spacecraft2": (self.config_visuals["value_spacecraft2"] + 1) % len(self.config_visuals["spacecrafts"])}),"command2":self.config_screen})
        self.increase_player2_button=Button({"screen": self.screen,"font": font2,"text": "v","position": (self.WIDTH/2+310,self.HEIGHT/2+50),"color2": self.GOLDEN,"sound_hover": self.sound_buttonletters,"sound_touch": self.sound_touchletters,"command1":lambda: self.config_visuals.update({"value_spacecraft2": (self.config_visuals["value_spacecraft2"] - 1) % len(self.config_visuals["spacecrafts"])}),"command2":self.config_screen})
        ...
        self.default_visual_button=Button({"screen": self.screen,"font": self.font5,"text": "Default config","position": (self.WIDTH/2+160,self.HEIGHT/2+160),"color2": self.GOLDEN,"sound_hover": self.sound_buttonletters,"sound_touch": self.sound_touchletters,"command1":lambda:self.config(visuals=True),"command2":self.load_images})
    def menu_keys(self):
        if self.main==6:
            self.screen.fill(self.BLACK)
